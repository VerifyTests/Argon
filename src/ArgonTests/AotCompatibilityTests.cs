...
public class AotCompatibilityTests
{
    ...
    public async Task Serialize_AnonymousObject_UnderAot()
    {
        ...
        var argonProjectPath = Path.Combine(ProjectFiles.SolutionDirectory, "Argon", "Argon.csproj");
        ...
        var csprojContent = $"""
                             <Project Sdk="Microsoft.NET.Sdk">
                               ...
                               <ItemGroup>
                                 <ProjectReference Include="{argonProjectPath}" />
                               </ItemGroup>
                             </Project>
                             """;
    ...
    static async Task<(bool success, string output)> PublishProject(string projectDir)
    {
        ...
        {
            startInfo.Environment["PATH"] = vsInstallerPath + Path.PathSeparator + Environment.GetEnvironmentVariable("PATH");
        }
