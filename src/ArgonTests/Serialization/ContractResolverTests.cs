...
{
    // CreateProperties used List.Sort (unstable introsort) so properties without an explicit Order
    // lost their declaration order once the type had more than 16 members and any property carried an Order.
    [Fact]
    public void PropertyOrderIsStableWhenAPropertyHasOrder()
    {
    ...
    [Fact]
    public void DefaultConvertersContainsASingleEncodingConverter()
    {
