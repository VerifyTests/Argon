...
static class ConvertUtils
{
    static readonly FrozenDictionary<Type, PrimitiveTypeCode> typeCodeMap =
        new KeyValuePair<Type, PrimitiveTypeCode>[]
        {
            ...
            new(typeof(bool?), PrimitiveTypeCode.BooleanNullable),
            new(typeof(sbyte), PrimitiveTypeCode.SByte),
            new(typeof(sbyte?), PrimitiveTypeCode.SByteNullable),
            new(typeof(short), PrimitiveTypeCode.Int16),
            new(typeof(short?), PrimitiveTypeCode.Int16Nullable),
            new(typeof(ushort), PrimitiveTypeCode.UInt16),
            new(typeof(ushort?), PrimitiveTypeCode.UInt16Nullable),
            new(typeof(int), PrimitiveTypeCode.Int32),
            new(typeof(int?), PrimitiveTypeCode.Int32Nullable),
            new(typeof(byte), PrimitiveTypeCode.Byte),
            new(typeof(byte?), PrimitiveTypeCode.ByteNullable),
            new(typeof(uint), PrimitiveTypeCode.UInt32),
            new(typeof(uint?), PrimitiveTypeCode.UInt32Nullable),
            new(typeof(long), PrimitiveTypeCode.Int64),
            new(typeof(long?), PrimitiveTypeCode.Int64Nullable),
            new(typeof(ulong), PrimitiveTypeCode.UInt64),
            new(typeof(ulong?), PrimitiveTypeCode.UInt64Nullable),
            ...
            new(typeof(DateTimeOffset?), PrimitiveTypeCode.DateTimeOffsetNullable),
            new(typeof(decimal), PrimitiveTypeCode.Decimal),
            new(typeof(decimal?), PrimitiveTypeCode.DecimalNullable),
            new(typeof(Guid), PrimitiveTypeCode.Guid),
            new(typeof(Guid?), PrimitiveTypeCode.GuidNullable),
            new(typeof(TimeSpan), PrimitiveTypeCode.TimeSpan),
            new(typeof(TimeSpan?), PrimitiveTypeCode.TimeSpanNullable),
            new(typeof(BigInteger), PrimitiveTypeCode.BigInteger),
            new(typeof(BigInteger?), PrimitiveTypeCode.BigIntegerNullable),
            new(typeof(Uri), PrimitiveTypeCode.Uri),
